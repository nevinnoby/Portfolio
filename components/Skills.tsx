...
const skills = [
  {
    ...
    description:
      "Expert in semantic markup, accessibility practices, and modern HTML5 features.",
    category: "Frontend",
  },
  {
    name: "CSS3",
    ...
    description:
      "Advanced skills in layouts, animations, responsive design, and CSS frameworks.",
    category: "Frontend",
  },
  {
    name: "JavaScript",
    ...
    description:
      "Expert in modern ES6+ features, async programming, and DOM manipulation.",
    category: "Frontend",
  },
  {
    name: "ReactJs",
  ...
  },
  {
    ...
    description:
      "Skilled in rapid prototyping and responsive UI development with Bootstrap components.",
    category: "Frontend",
  },
  {
    name: "PHP",
  ...
  },
  {
    ...
    description:
      "Experience with sorting, searching, dynamic programming, and optimization techniques.",
    category: "Computer Science",
  },
  {
    ...
    description:
      "Understanding of process management, memory allocation, file systems, and scheduling algorithms.",
    category: "Computer Science",
  },
];
  ...
  return (
    ...
    >
      <div className="p-8">
        ...
        <div
          className={`relative h-3 w-full rounded-full overflow-hidden mb-2 ${
  ...
  return (
    <div className="flex justify-between items-center w-full mt-12 mb-16">
      {categories.map((category, index) => (
        ...
        >
          <div className="w-4 h-4 rounded-full mb-2" style={{ backgroundColor: category.color }} />
      ...
      <div className="flex justify-between mt-2">
        {topSkills.map((skill, index) => (
          <span
            ...
            style={{ width: `${100 / topSkills.length}%`, textAlign: "center" }}
          >
            {skill.name}
          </span>
        ))}
